...
export default function RestaurantCard({ restaurant }) {
  ...
  return (
    <Link to={createPageUrl(`RestaurantDetail?id=${id}`)}>
      <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-stone-100">
        ...
        <div className="relative h-48 sm:h-56 overflow-hidden">
          <img
            src={cover_image || `https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80`}
            alt={name}
